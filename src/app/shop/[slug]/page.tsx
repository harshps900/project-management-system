    ...
    return (
        <div className="bg-background min-h-screen">
            ...
            {relatedProducts.length > 0 && (
                <section className="py-24 border-t border-border mt-12 bg-secondary/30">
                    <div className="max-w-7xl mx-auto px-4 md:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-4">
                            <div>
                                <span className="text-accent text-[10px] font-black uppercase tracking-[0.3em] mb-4 block italic">Curated Selection</span>
